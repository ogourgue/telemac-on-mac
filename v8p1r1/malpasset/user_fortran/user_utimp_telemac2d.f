...
!+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
!
      INTEGER IVAR,J,NRFO,INUM(14),IH,I
...
!
      SAVE INUM,IH,HAUT,ARR_TIME,FIND_ARR_TIME,DEJA_UTIMP, FON
!
!-----------------------------------------------------------------------
!
...
!
      IF(NCSIZE.GT.1) THEN
        DO J=1,14
          ...
          FON(J) = P_DMAX(FON(J))+P_DMIN(FON(J))
        ENDDO
        DO J=1,3
...
!
     ...
     &                    ' S'
      ...
      IF(LT.EQ.NIT) THEN
!     MASS FILE
        OPEN(UNIT=561456,FILE="../mass.txt")
